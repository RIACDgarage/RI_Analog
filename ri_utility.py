...
==============================================================================
 ...
 action_function_1 is limited to (-1, 0, +1) of the current state s
==============================================================================
"""
def action_function_1(sT, dmin, d1max, d2max): # sT is current state at t
...
==============================================================================
"""
def init_state_value(style, dmin, d1max, d2max, optstv, spice_interface):
    sample_1d = 20
    ...
    for i in range (samp2d): spice_interface.run_spice(design[i])
